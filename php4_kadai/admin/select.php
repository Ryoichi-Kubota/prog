...
<html lang="ja">
  <head>
    ...
    <title>AnalyticsTool CustomerSelect</title>
  </head>
                ...
                <tbody>
                  <?php foreach($users as $user): ?>
                    <tr>
                      ...
                      <td>
                        <button type="button" class="btn btn-blue" onclick="location.href='detail.php?id=<?php echo $user['id']; ?>'">編集</button>
                        <a class="btn btn-red" href="delete.php?id=<?php echo $user['id']; ?>" onclick="return confirm('会員ID<?php echo $user['id']; ?>のレコードを削除します。よろしいですか？')">削除</a>
                      </td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
